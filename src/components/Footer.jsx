				...
				<div id="footer" className="footer_container">
					<div className="innerFooter_container">
						<div className="left_side">
							...
							<br />
							<h5>
								Mekanisk propose des services de fabrication additive
								(impression 3d) de haute qualité, permettant des pièces robustes
								(qui peuvent être renforcées avec des fibres composites, des
								résines, des inserts métalliques, etc.)
							</h5>
						</div>
